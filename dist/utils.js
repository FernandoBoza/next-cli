...
function createComponent(name, type, client = false) {
    const componentDir = path_1.default.join(process.cwd(), 'app', type, capitalize(name));
    const componentFile = path_1.default.join(componentDir, client ? 'index.client.tsx' : 'index.tsx');
...
function createPage(name) {
    ...
    const pageDir = path_1.default.join(process.cwd(), 'app', name);
    const pageFile = path_1.default.join(pageDir, 'page.tsx');
...
function createLayout(name) {
    ...
    const layoutDir = path_1.default.join(process.cwd(), 'app', name);
    const layoutFile = path_1.default.join(layoutDir, 'layout.tsx');
